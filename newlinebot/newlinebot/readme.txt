Please create web.config with the following text:
...
<configuration>
  <appSettings>
    <add key="ChannelSecret" value="Your channel secret from line developer site" />
    <add key="ChannelToken" value="Your channel token from line developer site" />
  </appSettings>
  <system.web>
